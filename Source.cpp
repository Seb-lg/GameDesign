...
//	player = LoadObject::Cube({10.f, 0.5f, 10.f}, DEFAULTROT, {0.25f, 0.25f, 0.25f});
	player = LoadObject::FromSource("./components/heavytriangletank.obj",{10.f, 0.5f, 10.f}, DEFAULTROT,{0.25f, 0.25f, 0.25f});
...
//	ecs.getComponentMap<AStar>()[id].chain = pathfinding::Astar(Node(pos.x, pos.z), Node(10, 10), mapp);
	...
	for (int i = 0; i < 10; ++i) {
		auto elem = LoadObject::FromSource("./components/heavytriangletank.obj",
